 ...
 */
final class Version20241128094835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event ADD user_id INT DEFAULT NULL, ADD place_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE event DROP user_id, DROP place_id');
    }
}
